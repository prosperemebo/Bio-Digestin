<template>
  <section class="center-content py-9 relative">
    <div class="mb-4 md:grid md:grid-cols-3 md:gap-4 relative z-10">
      <h2 class="text-4xl font-display font-bold uppercase text-title mb-4 md:col-span-2 md:mr-9">
        {{ heading }}
      </h2>
	...
	:class="index % 2 !== 0 ? 'flex-row-reverse' : ''"
      >
        ...
        <div class="ml-2 md:ml-0">
          <h3 class="text-stroke-hover font-display text-2xl font-bold uppercase mb-2 md:text-5xl">
            {{ item.name }}
          </h3>
    ...
    <!-- Backdrop -->
    <div class="absolute top-0 -right-1/4  pointer-events-none w-full h-full opacity-30 hidden lg:block">
      <NuxtImg
